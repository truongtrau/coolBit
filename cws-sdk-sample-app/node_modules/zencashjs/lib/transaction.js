...
function inputSignature(_txObj, i, scriptSig, pubKey) {
  ...
  txObj.ins[0].script = zbufferutils.getPushDataLength(scriptSig) + scriptSig + zbufferutils.getPushDataLength(pubKey) + pubKey;
...
module.exports = {
  ...
  assemblMultipleIns: assemblMultipleIns
};